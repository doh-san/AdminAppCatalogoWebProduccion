                  ...
                  <div class="md-form">
                    <select class="mdb-select md-form" multiple searchable="Buscar..." name="clasificaciones[]" id="clasificaciones">
                      ...
                      @foreach ($clasificaciones as $clasificacion)
                        @foreach ($vendedor->clasificaciones as $cat)
                          @if ($cat->id_clasificacion == $clasificacion->id_clasificacion)
                            <option value="{{ $clasificacion->id_clasificacion }}" {{in_array($clasificacion->id_clasificacion, old("clasificaciones") ?: []) ? "selected": ""}} {{ $cat->id_clasificacion == $clasificacion->id_clasificacion ? 'selected' : '' }}>{{ $clasificacion->nombre }}</option>
                            @php
                              $i = 1
                            @endphp
                          @endif
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="mdb-lightbox">
                          ...
                          <figure class="col-md-4">
                            <a id="hImgId" href="{{$vendedor->identification}}" data-size="1600x1067">
                              <img id="iImgId" src="{{$vendedor->identification}}" class="img-fluid z-depth-1">
                            </a>
                            <p class="text-uppercase font-weight-bold blue-grey-text mt-4">Identificación</p>
                          </figure>

                          <figure class="col-md-4">
                            <a id="hImgComDom" href="{{$vendedor->voucher}}" data-size="1600x1067">
                              <img id="iImgComDom" src="{{$vendedor->voucher}}" class="img-fluid z-depth-1">
                            </a>
                            <p class="text-uppercase font-weight-bold blue-grey-text mt-4">Comprobante de Domicilio</p>
                          </figure>

                          <figure class="col-md-4">
                            <a id="hImgPerf" href="{{$vendedor->photography}}" data-size="1600x1067">
                              <img id="iImgPerf" src="{{$vendedor->photography}}" class="img-fluid z-depth-1">
                            </a>

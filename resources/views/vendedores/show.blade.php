                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <div class="card pricing-card">
                      ...
                      <div class="price header white-text mdb-color rounded-top">
                        <div class="version">
                          <h5>Clasificaciones Asignadas</h5>
                        </div>
                      </div>
                      ...
                      <div class="card-body striped mb-1">
                        ...
                        <ul>
                          @forelse($vendedor->clasificaciones as $clasificacion)
                            <li>
                              <p class="mt-2"><i class="fas fa-angle-right pr-2"></i>{{$clasificacion->nombre}}</p>
                            </li>
                          @empty
                              <li>
                                <p class="mt-2"><i class="fas fa-check green-text pr-2"></i>No Hay clasificaciones Asignadas</p>
                              </li>
                          @endforelse
                        </ul>

                      ...
                      <div class="col-md-12">
                        ...
                        <div class="mdb-lightbox">
                          ...
                          <figure class="col-md-4">
                            <a id="hImgId" href="" data-size="1600x1067">
                              <img id="iImgId" src="" class="img-fluid z-depth-1">
                            </a>
                            <p class="text-uppercase font-weight-bold blue-grey-text mt-4">Identificación</p>
                          </figure>

                          <figure class="col-md-4">
                            <a id="hImgComDom" href="" data-size="1600x1067">
                              <img id="iImgComDom" src="" class="img-fluid z-depth-1">
                            </a>
                            <p class="text-uppercase font-weight-bold blue-grey-text mt-4">Comprobante de Domicilio</p>
                          </figure>

                          <figure class="col-md-4">
                            <a id="hImgPerf" href="" data-size="1600x1067">
                              <img id="iImgPerf" src="" class="img-fluid z-depth-1">
                            </a>

              ...
              <div class="card-body card-body-cascade text-center">
                ...
                <form class="text-center col-md-10 offset-md-1" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0">
                        <input type="text" id="form1" class="form-control validate" value="{{ $v->clasificacion }}" disabled>
                        <label for="form1" data-error="wrong" data-success="right">Clasificación</label>
                      </div>
                    </div>
                    <!-- Second column -->
                    <div class="col-md-6">

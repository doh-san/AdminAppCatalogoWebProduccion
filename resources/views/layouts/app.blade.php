   ...
   <script>
      ...
      function readIdentification(input) {
       if (input.files && input.files[0]) {
         ...
         reader.onload = function(e) {
           $('#hImgId').attr('href', e.target.result);
           $('#iImgId').attr('src', e.target.result);
         }
      ...
      function readVoucher(input) {
       if (input.files && input.files[0]) {
         var reader = new FileReader();

         reader.onload = function(e) {
           $('#hImgComDom').attr('href', e.target.result);
           $('#iImgComDom').attr('src', e.target.result);
         }
      ...
      function readProfile(input) {
       if (input.files && input.files[0]) {
         ...
         reader.onload = function(e) {
           $('#hImgPerf').attr('href', e.target.result);
           $('#iImgPerf').attr('src', e.target.result);
           $('.mdb-lightbox').css('display','block');
         }

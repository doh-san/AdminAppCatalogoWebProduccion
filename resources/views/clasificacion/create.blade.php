...
<div class="container col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="row justify-content-center">
      ...
      <!-- Second column -->
          <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 mb-4 my-3">
            ...
            <div class="card card-cascade narrower">
              ...
              <div class="card-body card-body-cascade text-center">
                ...
                <!-- Edit Form -->
                <form class="text-center col-md-10 offset-md-1" method="POST" action="{{ url('clasificacion') }}" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12 clearfix">
                    ...
                    <div class="mdb-lightbox" style="display:none;">

                      <figure class="col-md-5" style="left: 50%; transform: translate(-50%);">
                        <a id="chImg" href="#" data-size="1600x1067">
                          <img id="ciImg" src="#" class="img-fluid">
                        </a>
                      </figure>

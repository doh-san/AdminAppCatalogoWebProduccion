              ...
              <div class="card-body card-body-cascade text-center">
                ...
                <form class="text-center col-md-10 offset-md-1" method="POST" action="{{ url('productos') }}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0">
                         <select class="mdb-select md-form colorful-select dropdown-ins" searchable="Buscar..." name="clasificacion">
                           <option value="" disabled selected>Elige tu opción</option>
                           @foreach ($clasificaciones as $clasificacion)
                             <option value="{{ $clasificacion->id_clasificacion }}" {{ old('clasificacion') == $clasificacion->id_clasificacion ? 'selected' : '' }}>{{ $clasificacion->nombre }}</option>
                           @endforeach
                         </select>
                  ...
                  <div class="md-form">
                     ...
                     @enderror
                     <label for="marca">Marca<span class="red-text">*</span></label>
                  </div>
